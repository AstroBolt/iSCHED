...
import mobcom.iacademy.thesis.controller.Group;
...
public class EditEventActivity extends AppCompatActivity implements
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            intent = new Intent(EditEventActivity.this, GroupInterfaceActivity.class);
            ...
            Toast.makeText(EditEventActivity.this, "Group Event not Saved.", Toast.LENGTH_SHORT).show();
        ...
        if ((ni != null) && (ni.isConnected())) {
            ...
            query.getInBackground(event.getId(), new GetCallback<ParseObject>() {
                ...
                public void done(ParseObject parseObject, ParseException e) {
                    parseObject.put("groupId", groupBean.getGroupId());
                    parseObject.put("groupName", groupBean.getGroupName());
                    parseObject.put("userId", ParseUser.getCurrentUser().getObjectId());
                    parseObject.put("username", ParseUser.getCurrentUser().getUsername());
                    parseObject.put("username", ParseUser.getCurrentUser().getObjectId());
                    parseObject.put("groupEvent", title);
                    ...
                    parseObject.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            intent.putExtra("groupName", groupBean.getGroupName());
                            intent.putExtra("id", groupBean.getGroupId());
                            Toast.makeText(EditEventActivity.this, "Group Event Saved.", Toast.LENGTH_SHORT).show();
                            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                            startActivity(intent);
                        }
                    });
                ...
                public void done(ParseObject parseObject, ParseException e) {
                    ...
                    parseObject.saveInBackground(new SaveCallback() {
                        ...
                        public void done(ParseException e) {
                            ...
                            intent.putExtra("groupName", groupBean.getGroupName());
                            intent.putExtra("id", groupBean.getGroupId());
                            Toast.makeText(EditEventActivity.this, "Delete Success", Toast.LENGTH_SHORT).show();
                            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                            startActivity(intent);
                        }
                    });
